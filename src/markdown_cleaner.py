...
class MarkdownCleaner:
    def __init__(self, fix_spacing: bool = True, 
...
def process_file(file_path: Path, cleaner: MarkdownCleaner, in_place: bool) -> Optional[str]:
...
def main():
    ...
    parser.add_argument('--no-spacing', action='store_false', dest='fix_spacing',
                       help='Disable fixing spacing')
    parser.add_argument('--no-headers', action='store_false', dest='standardize_headers',
                       help='Disable header standardization')
    parser.add_argument('--no-lists', action='store_false', dest='fix_lists',
                       help='Disable list fixing')
    parser.add_argument('--keep-blanks', action='store_false', dest='remove_multiple_blanks',
                       help='Keep multiple blank lines')
    parser.add_argument('--extract-text', '-e', action='store_true',
